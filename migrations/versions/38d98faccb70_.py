...
def upgrade():
    ...
    with op.batch_alter_table('user_musical_interest', schema=None) as batch_op:
        batch_op.drop_constraint('user_musical_interest_user_id_fkey', type_='foreignkey')
        batch_op.create_foreign_key(None, 'users', ['user_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('user_musical_interest', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('user_musical_interest_user_id_fkey', 'userss', ['user_id'], ['id'])

    with op.batch_alter_table('user_message_group', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('user_message_group_user_id_fkey', 'userss', ['user_id'], ['id'])

    with op.batch_alter_table('user_match', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('user_match_match_id_fkey', 'userss', ['match_id'], ['id'])
        batch_op.create_foreign_key('user_match_user_id_fkey', 'userss', ['user_id'], ['id'])

    with op.batch_alter_table('user_instrument', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('user_instrument_user_id_fkey', 'userss', ['user_id'], ['id'])

    with op.batch_alter_table('user_goal', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('user_goal_user_id_fkey', 'userss', ['user_id'], ['id'])

    with op.batch_alter_table('user_band', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('user_band_user_id_fkey', 'userss', ['user_id'], ['id'])

    with op.batch_alter_table('message', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('message_sender_id_fkey', 'userss', ['sender_id'], ['id'])

    with op.batch_alter_table('match_profile', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('match_profile_user_id_fkey', 'userss', ['user_id'], ['id'])
